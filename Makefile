...
help:
	...
	@echo "    docker-up-app: Run docker-compose up --remove-orphans"
	@echo "    docker-up-app-daemon: Run docker-compose up -d --remove-orphans"
	@echo "    docker-stop-app: Run docker-compose stop"
